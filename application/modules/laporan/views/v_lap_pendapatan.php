<div style="text-align:right; padding:5px">
  <a class="btn btn-success" href='<?php echo site_url("laporan/pendapatan_excel?tanggal_dari=$tanggal_dari&tanggal_sampai=$tanggal_sampai&unit=$unit"); ?>'><span class="fa fa-file-excel-o "></span> Export Excel</a>
  <br>
</div>
